...
export function Home() {
  ...
  return (
    <div className="min-h-screen">
            ...
            {[
              {
                icon: Code2,
                title: 'Học Thực Hành',
                description: 'Coding ngay trên trình duyệt, thực hành là cách tốt nhất để học lập trình'
              },
              {
                icon: BookOpen,
                title: 'Nội Dung Chất Lượng',
                description: 'Khóa học được biên soạn bởi các chuyên gia với kinh nghiệm thực tế'
              },
              {
                icon: Users,
                title: 'Cộng Đồng Hỗ Trợ',
                description: 'Tham gia cộng đồng học viên, hỏi đáp và chia sẻ kinh nghiệm'
              },
              {
                icon: Award,
                title: 'Chứng Chỉ Hoàn Thành',
                description: 'Nhận chứng chỉ sau khi hoàn thành khóa học để chứng minh kỹ năng'
              },
              {
                icon: Play,
                title: 'Học Mọi Lúc Mọi Nơi',
                description: 'Truy cập khóa học 24/7, học theo tốc độ của riêng bạn'
              },
              {
                icon: TrendingUp,
      ...
      {/* Demo Modal */}
      {showDemoModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowDemoModal(false)}>
          <motion.div
