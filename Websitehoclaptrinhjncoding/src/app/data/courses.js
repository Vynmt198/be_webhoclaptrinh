/**
 * @typedef {"Beginner" | "Intermediate" | "Advanced"} CourseLevel
 * @typedef {"Frontend" | "Backend" | "Full Stack" | "Mobile" | "Data Science"} CourseCategory
 *
 ...
 * @property {{ courses:number, students:number, rating:number, reviews:number }} stats
 * @property {{ website?:string, github?:string, linkedin?:string }} [social]
 *
 * @typedef {Object} CourseCurriculumSection
 ...
 * @property {CourseCurriculumSection[]} curriculum
...
export const courses = [
...

  {
    ...
    curriculum: [
      { section: "Next.js Fundamentals", lessons: ["App Router", "Routing", "Layouts", "Data Fetching"] },
      { section: "Server Components", lessons: ["Server vs Client Components", "Server Actions", "Streaming", "Caching"] },
    ],
  },

  {
    ...
    curriculum: [
      { section: "Python Basics", lessons: ["Python Syntax", "Data Types", "Functions", "OOP"] },
      { section: "Django Framework", lessons: ["Django Setup", "Models", "Views", "Templates", "Forms"] },
    ],
  },

  {
    ...
    curriculum: [
      { section: "Getting Started", lessons: ["Setup Environment", "Components", "Styling", "Layout"] },
      { section: "Advanced Topics", lessons: ["Navigation", "Async Storage", "API Integration", "Push Notifications"] },
    ],
  },
];
